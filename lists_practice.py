...
def n_long_words(words, n):
    ...
    n_word_list =[word for word in words if len(word) > n]
...
def halvesies(numbers):
    ...
    the half::
        ...
        [0.5, 2.5]
    """
    half_number = map(lambda number: number/2.0, numbers)
    return half_number
...
def duplicates(items):
    ...
    duplicate_set = set(duplicate_item)
